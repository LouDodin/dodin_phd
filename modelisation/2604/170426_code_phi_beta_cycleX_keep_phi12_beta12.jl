...
cycle = "5"
## ===== INPUT DATA =====
df_H = CSV.read(joinpath(@__DIR__, "input/xp_input_20/hostData_coevoCondition_Temperature20_ReplicateA_Cycle$(cycle).csv"), DataFrame)
df_V = CSV.read(joinpath(@__DIR__, "input/xp_input_20/virusData_coevoCondition_Temperature20_ReplicateA_Cycle$(cycle).csv"), DataFrame)
...
β = 155.56397628529712
ϕ = 7.275605942568924e-11
...
println("Saving plot...")
savefig(pl_sim, joinpath(@__DIR__, "170426_output/fit_phi_beta/cycle$(cycle)_model_SV_phi_beta_no_delta_keep_phi12_beta12.png"))