...
function objective_DE(θ)
    ...
    prob_new = ODEProblem(model_SV_no_delta, Y0, tspan, p)
...
#fits
prob_new = ODEProblem(model_SV_no_delta, Y0, tspan, exp.(θbest))
...
println("Saving plot...")
savefig(pl_data, joinpath(@__DIR__, "170426_output/model_SV_Cycle1_1_no_delta.png"))