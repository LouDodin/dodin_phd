...
for n_knots in n_knots_range
    ...
    plot_path = joinpath(@__DIR__, "240426_output/knots_dilutions_$(n_int)_plot.png")
    ...
    output_file = joinpath(@__DIR__, "240426_output/knots_dilutions_$(n_int)_polynome.txt")
