...
t_H1 = df_H1[1:end,1]./24; H1 = df_H1[1:end,2]
t_V1 = df_V1[1:end,1]./24; V1 = df_V1[1:end,2]
...
t_H3 = df_H2[1:end,1]./24; H3 = df_H2[1:end,2]
t_V3 = df_V2[1:end,1]./24; V3 = df_V2[1:end,2]
...
t_H5 = df_H3[1:end,1]./24; H5 = df_H3[1:end,2]
t_V5 = df_V3[1:end,1]./24; V5 = df_V3[1:end,2]
...
for (i, sol) in enumerate(sols[1:1])
...
for k in 1:2#length(phi_segments)-1
