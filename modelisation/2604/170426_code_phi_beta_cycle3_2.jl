...
## ===== INPUT DATA =====
df_H = CSV.read(joinpath(@__DIR__, "input/xp_input_20/hostData_coevoCondition_Temperature20_ReplicateA_Cycle3.csv"), DataFrame)
df_V = CSV.read(joinpath(@__DIR__, "input/xp_input_20/virusData_coevoCondition_Temperature20_ReplicateA_Cycle3.csv"), DataFrame)
t_H = df_H[4:end,1]./24; H = df_H[4:end,2]
t_V = df_V[4:end,1]./24; V = df_V[4:end,2]
...
println("Saving plot...")
savefig(pl_data, joinpath(@__DIR__, "170426_output/fit_phi_beta/cycle3_2_model_SV_only_beta_no_delta_fit_phi_beta.png"))