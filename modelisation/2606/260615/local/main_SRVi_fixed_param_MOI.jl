...
## ===== Choices =====
const MODEL_FILE = joinpath(@__DIR__, "models/model_SRVi_fixed_param.jl")
...
pl_fit = plot(
    ...
    xlabel = "Time [days]",
    legend = :bottomright,
    plot_title = "Alpha fixed - H0=$(H0) - V0=$(V0) - prop_S_0=$(prop_S_0)",
...
mkpath(joinpath(@__DIR__, "output/fixed_param"))
fig_path = joinpath(@__DIR__, "output/fixed_param/plot_$(fmt_sci(V0))_$(fmt_sci(H0))_$(fmt_sci(prop_S_0)).png")
