...
## ===== Select model =====
const MODEL_FILE = joinpath(@__DIR__, "models/model_SRVi_fit_phi_alpha.jl")
...
mkpath(joinpath(@__DIR__, "output/fit_phi_alpha"))
fig_path = joinpath(@__DIR__, "output/fit_phi_alpha/plot.png")
savefig(pl_fit, fig_path)
println("\nFigure saved to $fig_path")


## ===== Log =====
log_path = joinpath(@__DIR__, "output/fit_phi_alpha/log.txt")
