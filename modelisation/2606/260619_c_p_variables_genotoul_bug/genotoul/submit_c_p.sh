...
#SBATCH -o /work/user/ldodin/modelo/2606/260619/logs/job_%A_%a.out
#SBATCH -e /work/user/ldodin/modelo/2606/260619/logs/job_%A_%a.err

module purge
module load devel/Julia/1.11.4

WORKDIR=/work/user/ldodin/modelo/2606/260619
LOGDIR=$WORKDIR/logs
